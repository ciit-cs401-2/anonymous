...
<div class="bg-[#24263b] flex-1 flex flex-col gap-4 rounded-lg shadow-lg p-6"> {{-- Adjust background color --}}
    ...
    <div>
        ...
        <a href="{{ route('post.show', $post->id) }}" class="text-[#e94560] hover:underline text-sm">Read More</a>
    </div>
